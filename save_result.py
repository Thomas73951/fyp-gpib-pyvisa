...
ASSUMES MEAS2 IS S21, MEAS 1 IS S11
"""
...
# setup
START_FREQ = 10e6 # in Hz
STOP_FREQ = 100e6 # in Hz
...
if (SAVE_MEAS1):
    ...
    with open(filename_base + "_MEAS1.csv", 'w') as file:
        file.write(data)

if (SAVE_MEAS2):
    data = inst.query("TRAC? CH2FDATA")
    with open(filename_base + "_MEAS2.csv", 'w') as file:
        file.write(data)
